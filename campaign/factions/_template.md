...
from, or can help resolve.

## Representative Face

The NPC or public figure who makes this faction playable at the table.
...
People, places, money, leverage, secrets, weapons, or legitimacy.

## Rivals And Dependencies
...
Ways the player's history, resources, secrets, debts, goals, or relationships
can connect to this faction without forcing a single plot.

## Promotion Notes

Why this faction should stay at the current tier or move up/down.
