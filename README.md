...
genre-specific regex grants permission. The local Dashboard exposes only the
controlled character's bounded perspective and pending-turn interface while
keeping campaign and GM-only files private.
